...
<body>
    ...
    <p style="text-align: justify">Atas bantuannya, kami ucapkan terima kasih</p>
    ...
    <table width="100%" style="margin-top:30px;">
        <tr>
            <td width="50%" style="text-align:left; vertical-align:top;">
                ...
                {{ $pimpinan1['fakultas'] }}
                <br>
                <img src="{{ public_path($pimpinan1['ttdPath']) }}" alt="TTD" style="width:160px;"><br>
            ...
            <td width="50%" style="text-align:left; vertical-align:top;">
                ...
                Prodi DKV - FHIK
                <br>
                <img src="{{ public_path($pimpinan2['ttdPath']) }}" alt="TTD" style="width:180px; margin-top:3px"><br>
